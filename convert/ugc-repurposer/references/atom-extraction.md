...
2. **Against recent memory** — read atom records saved in `memory/influencer/ugc-repurposer/` dated within the last 30 days and compare new atoms against those. If J ≥ 0.70 against a recent atom, flag it as already-used and either skip it or note it as a deliberate refresh.
