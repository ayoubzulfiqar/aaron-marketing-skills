# UGC Repurposer — Templates & Specs

Fill-in templates, format specs, and worked examples for each step of the repurposing workflow. Linked from [SKILL.md](../SKILL.md).
...
## Step 2 — Repurposing Opportunity Map
...
## Step 4 — Format Transformation Specs
...
## Step 6 — Content Library Structure
...
## Worked Example — 3 TikTok videos
