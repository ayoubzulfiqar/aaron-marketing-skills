...
**Scope**: quality and regression review examples covering all 48 skills (26 Search/SEO-GEO + 18 influencer/IMPACT + 4 paid ads) and the `/aaron-marketing:auto`/`/aaron-marketing:auto --deep` natural-language router
