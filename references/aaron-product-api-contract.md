...
- Execute the end-to-end command chain implied by the user goal — `/aaron-marketing:seo-geo` modes for SEO/GEO, `/aaron-marketing:influencer` phases for influencer, `/aaron-marketing:ad` phases for paid, `/aaron-marketing:email` phases for email — using the smallest depth that can produce the requested outcome.
- Route influencer, paid, and email goals to the matching influencer / ROAS / SEND skill by name; do not decline them and do not force them through an SEO/GEO mode.
...
- Coordinate the discipline commands (`seo-geo`, `influencer`, `ad`, `email`) without bypassing their gates.
