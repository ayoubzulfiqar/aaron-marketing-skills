# Audience Analyzer — Templates

Fill-in templates for each step of the audience analysis. Mark every inferred attribute with a confidence level (High/Med/Low) so unsupported guesses stay visible. Lead with user-supplied data.
...
2. **Don't assume** — validate hypotheses with research; mark inferred attributes with a confidence level.
